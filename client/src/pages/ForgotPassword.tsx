    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-slate-500 mb-2">重置密码链接已发送至</p>
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">输入注册邮箱，我们将发送重置链接</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xl">
          ...
          >
            <div>
              <Label className="text-slate-600 text-sm mb-1.5 block">注册邮箱</Label>
