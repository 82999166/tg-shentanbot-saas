    ...
    <AdminLayout title="订单管理">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">查看和处理用户的套餐购买订单</p>
        </div>
        ...
        <Card className="bg-slate-100 border-slate-200">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button size="sm" variant="ghost" className="h-7 w-7 p-0 text-slate-500" onClick={() => refetch()} disabled={isRefetching}>
          ...
          <CardContent>
            {!orders || orders.length === 0 ? (
              ...
              <div className="space-y-3">
                {orders.map((o: any) => (
                  <div key={o.id} className="flex items-center justify-between bg-white rounded-lg px-4 py-3 border border-slate-200">
